...
lyr_srm_1.set('fieldAliases', {'id': 'id', 'population': 'population', 'Block Name': 'Block Name', });
lyr_srm_1.set('fieldImages', {'id': '', 'population': '', 'Block Name': '', });
lyr_srm_1.set('fieldLabels', {'id': 'no label', 'population': 'no label', 'Block Name': 'no label', });
